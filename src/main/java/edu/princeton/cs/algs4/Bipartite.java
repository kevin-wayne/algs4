 ...
 * bipartite or whether it has an odd-length cycle. The <em>isBipartite</em> operation determines
 ...
 * <em>E</em> is the number of edges. Afterwards, the <em>isBipartite</em> and <em>color</em>
 * operations take constant time; the <em>oddCycle</em> operation takes time proportional to the
 * length of the cycle. See {@link BipartiteX} for a nonrecursive version that uses breadth-first
 * search.
 *
