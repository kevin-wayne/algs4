 ...
 * O(<Em>E</em> + <em>V</em>) time, and uses O(<em>V</em>) extra space, where <em>E</em> is the
 * number of edges and <em>V</em> the number of vertices All other methods take O(1) time.
 *
