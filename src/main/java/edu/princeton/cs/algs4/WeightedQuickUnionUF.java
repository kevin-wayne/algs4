 ...
 *
 * <p>This implementation uses weighted quick union by size (without path compression). Initializing
 * a data structure with <em>n</em> sites takes linear time. Afterwards, the <em>union</em>,
