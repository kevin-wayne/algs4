...
public class DigraphGenerator {
  ...
  /**
   * Returns a random tournament digraph on {@code V} vertices. A tournament digraph is a DAG in
   * which for every two vertices, there is one directed edge. A tournament is an oriented complete
   * graph.
   *
   * @param V the number of vertices
