 ...
 * the given range. The <em>insert</em>, <em>delete-the-maximum</em>, <em>delete</em>,
 * <em>change-key</em>, <em>decrease-key</em>, and <em>increase-key</em> operations take logarithmic
 * time. The <em>is-empty</em>, <em>size</em>, <em>max-index</em>, <em>max-key</em>, and
 * <em>key-of</em> operations take constant time. Construction takes time proportional to the
 * specified capacity.
 *
