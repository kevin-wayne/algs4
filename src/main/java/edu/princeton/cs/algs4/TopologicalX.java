 ...
 * vertices and <em>E</em> is the number of edges. Afterwards, the <em>hasOrder</em> and
 * <em>rank</em> operations takes constant time; the <em>order</em> operation takes time
