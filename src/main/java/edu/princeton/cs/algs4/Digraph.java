 ...
 * the vertices adjacent from a given vertex. Parallel edges and self-loops are permitted.
 *
 ...
 * the vertices adjacent from a given vertex, which takes time proportional to the number of such
 * vertices.
 *
